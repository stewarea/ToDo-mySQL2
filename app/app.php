<?php
    ...
    $app->get("/tasks", function() use ($app) {
        return $app['twig']->render('tasks.html.twig', array('tasks_incomplete' => Task::getIncomplete(), 'tasks_complete' => Task::getComplete()));
    });
    ...
    $app->post("/tasks", function() use ($app) {
        ...
        $task = new Task($description, $id = null, $completed = 0, $due_date);
        $task->save();
        return $app['twig']->render('tasks.html.twig', array('tasks_incomplete' => Task::getIncomplete(), 'tasks_complete' => Task::getComplete()));
    });
    ...
    $app->post("/mark_completed", function() use ($app) {
        $task = Task::find($_POST['completed_task']);
